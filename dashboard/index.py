...
covid_data["active"] = (
    covid_data["confirmed"] - covid_data["death"] - covid_data["recovered"]
)

covid_data_1 = (
    covid_data.groupby(["date"])[["confirmed", "death", "recovered", "active"]]
    .sum()
    .reset_index()
)

covid_data_2 = (
    covid_data.groupby(["date", "Country/Region"])[
...
def update_confirmed(w_countries):
    ...
    value_confirmed = (
        covid_data_2[covid_data_2["Country/Region"] == w_countries]["confirmed"].iloc[
            -1
        ]
        - covid_data_2[covid_data_2["Country/Region"] == w_countries]["confirmed"].iloc[
            -2
...
def update_confirmed(w_countries):
    ...
    value_death = (
        covid_data_2[covid_data_2["Country/Region"] == w_countries]["death"].iloc[-1]
...
def update_confirmed(w_countries):
    ...
    value_recovered = (
        covid_data_2[covid_data_2["Country/Region"] == w_countries]["recovered"].iloc[
            -1
        ]
        - covid_data_2[covid_data_2["Country/Region"] == w_countries]["recovered"].iloc[
            -2
...
def update_confirmed(w_countries):
    ...
    value_active = (
        covid_data_2[covid_data_2["Country/Region"] == w_countries]["active"].iloc[-1]
...
def update_graph(w_countries):
    ...
    new_confirmed = covid_data_2[covid_data_2["Country/Region"] == w_countries][
        "confirmed"
    ].iloc[-1]
    new_death = covid_data_2[covid_data_2["Country/Region"] == w_countries][
        "death"
    ].iloc[-1]
    new_recovered = covid_data_2[covid_data_2["Country/Region"] == w_countries][
        "recovered"
    ].iloc[-1]
    new_active = covid_data_2[covid_data_2["Country/Region"] == w_countries][
        "active"
    ].iloc[-1]
...
def update_graph(w_countries):
    ...
    covid_data_3["daily confirmed"] = covid_data_3["confirmed"] - covid_data_3[
        "confirmed"
    ].shift(1)
    covid_data_3["Rolling Ave."] = (
        covid_data_3["daily confirmed"].rolling(window=7).mean()
    )

    return {
        "data": [
            go.Bar(
                x=covid_data_3[covid_data_3["Country/Region"] == w_countries][
                    "date"
                ].tail(30),
                y=covid_data_3[covid_data_3["Country/Region"] == w_countries][
                    "daily confirmed"
                ].tail(30),
                ...
                hoverinfo="text",
                hovertext="<b>Date</b>: "
                + covid_data_3[covid_data_3["Country/Region"] == w_countries]["date"]
                .tail(30)
                .astype(str)
                + "<br>"
                + "<b>Daily confirmed</b>: "
                + [
                    f"{x:,.0f}"
                    for x in covid_data_3[
                        covid_data_3["Country/Region"] == w_countries
                    ]["daily confirmed"].tail(30)
                ]
                + "<br>"
                + "<b>Country</b>: "
                + covid_data_3[covid_data_3["Country/Region"] == w_countries][
                    "Country/Region"
                ]
                .tail(30)
                .astype(str)
...
@app.callback(Output("map", "figure"), [Input("w_countries", "value")])
def update_graph(w_countries):
    covid_data_3 = (
        covid_data.groupby(["Lat", "Long", "Country/Region"])[
            ["confirmed", "death", "recovered", "active"]
        ]
        .max()
        .reset_index()
    ...
    return {
        "data": [
            go.Scattermapbox(
                ...
                + covid_data_4["Country/Region"].astype(str)
                + "<br>"
                + "<b>Longitude</b>: "
                + covid_data_4["Long"].astype(str)
                + "<br>"
                + "<b>Latitude</b>: "
                + covid_data_4["Lat"].astype(str)
                + "<br>"
                + "<b>Confirmed</b>: "
                + [f"{x:,.0f}" for x in covid_data_4["confirmed"]]
                + "<br>"
                + "<b>Death</b>: "
                + [f"{x:,.0f}" for x in covid_data_4["death"]]
                + "<br>"
                + "<b>Recovered</b>: "
                + [f"{x:,.0f}" for x in covid_data_4["recovered"]]
                + "<br>"
                + "<b>Active</b>: "
                + [f"{x:,.0f}" for x in covid_data_4["active"]]
                + "<br>",
            )
        ],
        "layout": go.Layout(
